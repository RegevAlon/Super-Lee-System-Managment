...
class CategoryControllerTest {
    ...
    void setUp() throws Exception {
        ...
        MilkProducts = cc.addCategory("MilkProducts", null);
        Milk = cc.addCategory("Milk", MilkProducts.getId());
    }
    ...
    void addCategory() throws Exception {
        Milk9p = cc.addCategory("Milk9p", Milk.getId());
    ...
    void getSubCategories() throws Exception {
        Milk9p = cc.addCategory("Milk9p", Milk.getId());
        Milk3p = cc.addCategory("Milk3p", Milk.getId());
